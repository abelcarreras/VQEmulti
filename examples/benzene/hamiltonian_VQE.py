...
molecule = run_pyscf(benzene, run_fci=False, nat_orb=True, guess_mix=False, verbose=True, frozen_core=19, n_orbitals=23)

# get properties from classical SCF calculation
n_electrons = molecule.n_electrons - 19 * 2
n_orbitals = 23 - 19  # molecule.n_orbitals
...
#store_wave_function(result['coefficients'], result['ansatz'], filename='wf_fermion.yml')
#print('stored')
