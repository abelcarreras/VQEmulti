...
coeff, ansatz = load_wave_function(filename='wf_h4.yml', qubit_op=True)
...
hamiltonian = load_hamiltonian(file='hamiltonian_h4.npz')
...
with Session(backend=backend) as session:
    ...
    for i in range(10):
        ...
        #print('=====')
        variance = simulate_adapt_vqe_variance(coeff_,
                                               ansatz_,
                                               hf_reference_fock,
                                               hamiltonian,
                                               simulator_var)
