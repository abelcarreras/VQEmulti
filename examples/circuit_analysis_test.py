...
conf = Configuration()
# set mapping
conf.mapping = 'jw'  # jw: Jordan-wigner , bk: Bravyi-Kitaev, pc: parity transform
# set printing level
...
# define simulator
simulator = QiskitSimulator(trotter=False,
                            test_only=False,  # test only (evaluate circuit exactly)
