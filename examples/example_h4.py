...
molecule_1 = run_pyscf(h2_molecule, run_fci=True, run_ccsd=True, nat_orb=False, guess_mix=False)

# get properties from classical SCF calculation
n_electrons = 4  # molecule_1.n_electrons
n_orbitals = 4  # molecule_1.n_orbitals
