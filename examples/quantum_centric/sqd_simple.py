...
energy = get_dmrg_energy(hamiltonian, n_electrons, max_bond_dimension=200)
#energy = get_dmrg_energy(hamiltonian, n_electrons, stream_output=True, max_bond_dimension=10, sample=0.1,
#                         occupations=[1, 1, 1, 1, 0, 0, 0, 0])
...
sym_orbitals = symmetrize_molecular_orbitals(molecule, 'D2h', skip=True, frozen_core=frozen_orb, n_orbitals=n_total)
...
for n_shots in range(100, 650, 50):
    ...
    print('energy SQD: ', n_shots, np.average(e_list))
