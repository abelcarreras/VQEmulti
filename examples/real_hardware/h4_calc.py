...
#from shot_models import get_evaluation_shots_model_1 as shots_model_energy
#from shot_models import get_evaluation_shots_model_2 as shots_model_energy
#from shot_models import get_evaluation_shots_model_3 as shots_model_energy
#from shot_models import get_evaluation_shots_model_4 as shots_model_energy
from shot_models import get_evaluation_shots_model_5 as shots_model_energy
#from shot_models import get_evaluation_shots_model_6 as shots_model_energy
...
molecule = run_pyscf(h4_molecule, run_fci=True, nat_orb=True, guess_mix=True, verbose=True)
...
with Session(backend=backend) as session:
    ...
    opt_cobyla = OptimizerParams(method='COBYLA', options={'rhobeg': 0.01, 'maxiter': 60})
...
for i, en in enumerate(energies_list):
    print('{:16.12f} {:16.12f} '.format(en, error_list[i]))
